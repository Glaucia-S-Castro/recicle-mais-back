...
export class scheduleDTO {
  ...
  //... a partir daqui
  //classe renomeada ja usando nas importações necessárias
  //falta refazer a lógica para determinar os campos específicos dos agendamentos e mudar as mensagens do swagger
